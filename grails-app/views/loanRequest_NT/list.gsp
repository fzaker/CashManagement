...
<div class="left" style="width: 50%">
    <div class="fieldcontain">
        ...
        <span class="property-value"><g:formatNumber
                number="${permitAmount}" maxFractionDigits="0" roundingMode="${RoundingMode.DOWN}"
                type="number"/></span>
    </div>
...
<div class="right" style="width: 50%">
    <div class="fieldcontain">
        ...
        <span class="property-value"><span id="manabe"><g:formatNumber
                number="${manabe}" maxFractionDigits="0" roundingMode="${RoundingMode.DOWN}" type="number"/></span>
        </span>
    </div>
        ...
        <div class="form-fields-part inline">
            <div class="fieldcontain">
                ...
                <g:select
                        ...
                        optionKey="id" name="loanType.id"
                        value="${loanRequest_nt?.loanType?.id ?: params['loanType.id']}"/>
            </div>

            <div class="fieldcontain">
                <label for="loanNo"><g:message code="loanNo"/></label>
                <g:textField name="loanNo" required="true" value="${loanRequest_nt?.loanNo ?: params['loanNo']}"/>
            </div>
            <div class="fieldcontain">
                <label for="customerType"><g:message code="customerType"/></label>
                <g:select
                        from="${new cashmanagement.LoanRequest_NT().constraints.customerType.inList}"
                        name="customerType" valueMessagePrefix="customerType"
                        value="${loanRequest_nt?.customerType ?: params['customerType']}"/>
            </div>
            <div class="fieldcontain">
                <label for="name"><g:message code="loanRequest_NT.name"/></label>
                <g:textField name="name" required="true" value="${loanRequest_nt?.name ?: params['name']}"/>
            </div>

            <div class="fieldcontain">
                <label for="family"><g:message code="loanRequest_NT.family"/></label>
                <g:textField name="family" required="true" value="${loanRequest_nt?.family ?: params['family']}"/>
            </div>
            <div class="fieldcontain">
                <label for="melliCode"><g:message code="loanRequest_NT.melliCode"/></label>
                <g:textField name="melliCode" required="true"
                             value="${loanRequest_nt?.melliCode ?: params['melliCode']}"/>
            </div>

            <div class="fieldcontain">
                <label for="loanAmount"><g:message code="loanAmount"/></label>
                <g:textField name="loanAmount" required="true"
                             value="${g.formatNumber(number: loanRequest_nt?.loanAmount) ?: params['loanAmount']}"/>
...
<div id="manoto">
    ...
    <div id="pending">
        <rg:criteria inline="true" id='pend'>
            ...
            <rg:filterGrid grid="LoanRequest_NTPendingListGrid"/>
        </rg:criteria>
    ...
    <div id="Confirm">
        <rg:criteria inline="true" id='conf'>
            ...
            <rg:eq hidden='true' name="branch.id" value="${branch?.id}"/>
            <rg:filterGrid grid="LoanRequest_NTConfirmListGrid"/>
        </rg:criteria>
        <rg:grid domainClass="${cashmanagement.LoanRequest_NT}"
                 columns="[[name: 'loanIDCode'], [name: 'loanNo'], [name: 'loanType'],[name: 'customerType'],  [name: 'name'], [name: 'family'], [name: 'melliCode'], [name: 'loanAmount'], [name: 'requestDate']]"
    ...
    <div id="Paid">
        <rg:criteria inline="true" id='paid'>
            ...
            <rg:eq hidden='true' name="branch.id" value="${branch?.id}"/>
            <rg:filterGrid grid="LoanRequest_NTPaidListGrid"/>
        </rg:criteria>
        <rg:grid domainClass="${cashmanagement.LoanRequest_NT}"
                 columns="[[name: 'loanIDCode'], [name: 'loanNo'], [name: 'loanType'],[name: 'customerType'], [name: 'name'], [name: 'family'], [name: 'melliCode'], [name: 'loanAmount'], [name: 'requestDate']]"
                 idPostfix="PaidList"
    ...
    <div id="Test">
        <rg:criteria inline="true" id='sent'>
            <rg:ilike name='loanNo'/>
            <rg:ilike name='melliCode'/>
            <rg:eq name="loanRequestStatus" hidden='true' value="${cashmanagement.LoanRequest_NT.Sent}"/>
            <rg:eq hidden='true' name="branch.id" value="${branch?.id}"/>
            <rg:filterGrid grid="LoanRequest_NTSentListGrid"/>
        </rg:criteria>
        <rg:grid domainClass="${cashmanagement.LoanRequest_NT}"
                 idPostfix="SentList"
                 maxColumns="8"
    ...
    <div id="Rejected">
        <rg:criteria inline="true" id='rej'>
            ...
            <rg:eq hidden='true' name="branch.id" value="${branch?.id}"/>
            <rg:filterGrid grid="LoanRequest_NTRejectedListGrid"/>
        </rg:criteria>
        <rg:grid domainClass="${cashmanagement.LoanRequest_NT}"
                 columns="[[name: 'loanNo'], [name: 'loanType'],[name: 'customerType'], [name: 'name'], [name: 'family'], [name: 'melliCode'], [name: 'loanAmount'], [name: 'requestDate'], [name: 'rejectReason'], [name: 'rejectUser']]"
