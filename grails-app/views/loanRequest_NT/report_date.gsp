...
<div id="list-loanRequest_NT" class="content scaffold-list" role="main">
    ...
    <div class="fieldcontain bank-region-percent">
        ...
        <span class="property-label-my max-growth"><g:message code="manabe" /></span>
        <span class="property-label-my max-growth"><g:message code="masaref" /></span>
    ...
    <g:each in="${branches}" var="br">
        <div class="fieldcontain bank-region-percent">
            ...
            <span class="property-label-my max-growth"><g:formatNumber number="${br.manabe}" type="number"/></span>
            <span class="property-label-my max-growth"><g:formatNumber number="${br.masaref}" type="number"/></span>
