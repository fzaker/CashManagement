    ...
    <div class="form-field">
        <div class="form-fields-part inline">
            ...
            <div class="fieldcontain">
                ...
                <g:textField name="loanNo" required="true" value="${loanRequest_gh?.loanNo}"/>
            </div>

            <div class="fieldcontain">
                <label for="name"><g:message code="loanRequest_T.name"/></label>
                <g:textField name="name" required="true" value="${loanRequest_gh?.name}"/>
            </div>

            <div class="fieldcontain">
                <label for="family"><g:message code="loanRequest_T.family"/></label>
                <g:textField name="family" required="true" value="${loanRequest_gh?.family}"/>
            </div>

            <div class="fieldcontain">
                <label for="melliCode"><g:message code="loanRequest_T.melliCode"/></label>
                <g:textField name="melliCode" required="true" value="${loanRequest_gh?.melliCode}"/>
            </div>

            <div class="fieldcontain">
                <label for="loanAmount"><g:message code="loanAmount"/></label>
                <g:textField name="loanAmount" required="true" value="${g.formatNumber(number:loanRequest_gh?.loanAmount)}"/>
