			...
			<ol class="property-list branch">
				...
				<li class="fieldcontain">
					<span id="branchHead-label" class="property-label"><g:message code="branch.branchHead.label" default="Branch Head" /></span>
						...
						<span class="property-value" aria-labelledby="branchHead-label"><g:link controller="branchHead" action="show" id="${branchInstance?.branchHead?.id}">${branchInstance?.branchHead?.encodeAsHTML()}</g:link></span>
