...
<head>
    ...
    <rg:highchartsResources></rg:highchartsResources>
</head>
...
<c:isBranchUser>
    <div>
        <div style="display: inline-block; width: 48%;">
            <rg:chart id="sumLoanBranch" chart="sumLoanBranch" domainClass="${cashmanagement.LoanRequest_NT}" yTitle="--"/>
        </div>

        <div style="display: inline-block; width: 48%;">
            <rg:chart id="masarefbemanabe" chart="masarefbemanabe" domainClass="${cashmanagement.LoanRequest_NT}"
                      yTitle="--"/>
        </div>
    </div>
</c:isBranchUser>
...
<c:isBankRegionUser>
    <div>
        <div style="display: inline-block; width: 48%;">
            <rg:chart id="availableBrancheHeads" chart="availableBrancheHeads" domainClass="${cashmanagement.LoanRequest_NT}" yTitle="--"/>
        </div>

        <div style="display: inline-block; width: 48%;">
            <rg:chart id="masarefbemanabeBrancheHeads" chart="masarefbemanabeBrancheHeads" domainClass="${cashmanagement.LoanRequest_NT}"
                      yTitle="--"/>
        </div>
    </div>
</c:isBankRegionUser>
